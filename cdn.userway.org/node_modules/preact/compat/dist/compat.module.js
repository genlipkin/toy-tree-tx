...
}(E.prototype = new n).isPureReactComponent = !0, E.prototype.shouldComponentUpdate = function(n, t) {
...
}(F.prototype = new n).__a = function(n) {
    var t = this,
        e = L(t.__v),
        r = t.o.get(n);
    return r[0]++,
...
function sn(n) {
    return fn(n) ? l.apply(null, arguments) : n
}
...
export {
    I as Children, E as PureComponent, mn as StrictMode, D as Suspense, F as SuspenseList, un as __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, sn as cloneElement, cn as createFactory, P as createPortal, xn as
    default, vn as findDOMNode, pn as flushSync, w as forwardRef, q as hydrate, gn as isElement, ln as isFragment, an as isMemo, fn as isValidElement, O as lazy, C as memo, $ as render, yn as startTransition, hn as unmountComponentAtNode, dn as unstable_batchedUpdates, _n as useDeferredValue, Sn as useInsertionEffect, En as useSyncExternalStore, bn as useTransition, on as version
};
